...
from models import (IntegrationTableModel,
                    RiskTableModel,
    ...
    def recalc_ancestors(self, start_row):
        ...
        while True:
            ...
            if child_starts and child_ends:
                ...
                self._data[parent][7] = days_between(self._data[parent][5].toString("yyyy-MM-dd HH:mm"), self._data[parent][6])  # duration is not the sum of child durations, but the number of days between the earliest start and latest end
